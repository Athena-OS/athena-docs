    ...
    starlight({
      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            // Each item here is one entry in the navigation menu.
            { label: "Display Manager", link: "/en/environment/display-manager" },
            { label: "GNOME", link: "/en/environment/gnome" },
            { label: "Bspwm", link: "/en/environment/bspwm" },
            { label: "KDE Plasma", link: "/en/environment/kde" },
            { label: "MATE", link: "/en/environment/mate" },
            { label: "Cinnamon", link: "/en/environment/cinnamon" },
            { label: "XFCE", link: "/en/environment/xfce" },
            { label: "Hyprland", link: "/en/environment/hyprland" },
            { label: "Themes", link: "/en/environment/themes" },
          ],
        },
        //{
        //  label: "Customization",
