  ...
  integrations: [starlight({
    ...
    sidebar: [{
      ...
      // { label: 'Calamares Installer', link: '/en/configuration/calamares' },
      {
        ...
        label: 'Shell',
        link: '/en/configuration/shell'
      }, {
        label: 'Display Manager',
        link: '/en/configuration/display-manager'
      }, {
        label: 'GNOME',
        link: '/en/configuration/gnome'
      }, {
        label: 'Bspwm',
        link: '/en/configuration/bspwm'
      }, {
        label: 'KDE Plasma',
        link: '/en/configuration/kde'
      }, {
        label: 'MATE',
        link: '/en/configuration/mate'
      }, {
        label: 'Cinnamon',
        link: '/en/configuration/cinnamon'
      }, {
        label: 'XFCE',
        link: '/en/configuration/xfce'
      }, {
        label: 'Hyprland',
      ...
      // Each item here is one entry in the navigation menu.
      {
        label: 'Athena Welcome',
        link: '/en/resources/athena-welcome'
      }, {
        label: 'Pentesting Tools',
        link: '/en/resources/pentesting-tools'
      }, {
        label: 'Athena Cyber Hub',
        link: '/en/resources/cyber-hub'
      }, {
        label: 'Hack The Box Toolkit',
        link: '/en/resources/htb-toolkit'
      }, {
        label: 'PWNage Menu',
        link: '/en/resources/pwnage-menu'
      }, {
        label: 'Blue Team Menu',
        link: '/en/resources/blueteam-menu'
      }, {
        label: 'Red Team Menu',
        link: '/en/resources/redteam-menu'
      }, {
        label: 'Payload to Dock',
        link: '/en/resources/payload-dock'
      }, {
