...
The desktop in both of the XFCE environments is pretty simple in terms of elements. You have mainly a bar, a wallpaper and a sidebar on picom environment.
