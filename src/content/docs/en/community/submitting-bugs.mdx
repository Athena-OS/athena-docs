...
Access to the [ticketing system](https://github.com/Athena-OS/athena-iso/issues/new/choose). On **Bug report** entry, click on **Get started**. Here you need to fill all fields like:
* Athena OS version
...
If you discover an issue to a package or tool not maintained in Athena repository, retrieve the URL of the project source, open a ticket on that project source page and open an issue ticket on Athena OS, as explained above, reporting the link of your opened ticket. In this manner, we can track also issues related to other packages or tools.