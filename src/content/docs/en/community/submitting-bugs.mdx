...
Access to the [ticketing system](https://github.com/Athena-OS/athena-nix/issues/new/choose). On **Bug report** entry, click on **Get started**. Here you need to fill all fields like:
* Athena OS version
