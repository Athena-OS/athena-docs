...
Being based on Arch Linux, Athena embraces entirely the [philosophy of Arch Community](https://terms.archlinux.org/docs/code-of-conduct/) and is based on the following [principles](https://wiki.archlinux.org/title/Arch_Linux#Principles):
* Simplicity
* Modernity
* Pragmatism
* User centrality
