---
title: Dory Installer
description: How to install Athena OS by Dory Installer.
---
...
Dory can be run by running `dory` command and requires a working Internet connection.
