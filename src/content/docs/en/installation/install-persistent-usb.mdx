...
On **Partitioning** section, follow [Aegis Partitioning](/en/installation/aegis/#partitioning), EFI or GRUB Legacy according to your setup, and select the name of the USB-2 device.
