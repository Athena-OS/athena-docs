...
Once you land on the Live Environment, attach USB-2 to a different USB port and be sure it is working, and follow the [Aegis TUI Installer](/en/configuration/aegis-tui/) chapter until the **Partitions** section.

## Partitioning

On **Partitions** section, follow [Aegis TUI Manual Partitioning](/en/installation/install-dual-boot/#partitioning) EFI or BIOS-Legacy according to your setup, and select the name of the USB-2 device.
