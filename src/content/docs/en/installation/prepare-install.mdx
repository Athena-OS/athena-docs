...
Athena Nix requires:
* A minimum of 30GB hard disk space for installation.
* A minimum of 4GB RAM + 4GB of Swap partition
* A bootable CD-DVD drive or a USB stick.
...
If you want to deploy Athena OS as virtual machine, refers to:
   ...
   * [Installing as guest in QEMU/KVM](/en/installation/install-guest-qemu/)
