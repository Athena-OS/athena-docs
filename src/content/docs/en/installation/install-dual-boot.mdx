...
![Install alongside](@assets/calamares-partition-alongside.png)
...
![GParted Resize](@assets/gparted-resize.png)
...
![GParted Apply](@assets/gparted-apply.png)

On the appearing popup window, click on **Apply**.

![GParted Apply Confirmation](@assets/gparted-apply-confirm.png)
...
![Replace a partition](@assets/calamares-partition-replace.png)
...
![Manual partitioning](@assets/calamares-partition-manual.png)
