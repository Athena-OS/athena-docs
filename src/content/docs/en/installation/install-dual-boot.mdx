...
An example partition layout will be shown according to your boot system.
...
Select the disk to work on. It is needed now to create the needed partitions for Athena OS.
...
:::note
Note: if you are going to enable Zram, you don't need to create a Swap partition.
:::
