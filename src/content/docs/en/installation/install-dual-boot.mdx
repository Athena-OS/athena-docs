...
Continue to follow the [Partitioning Final Steps](/en/configuration/aegis-tui/#final-steps).
...
Then, continue to follow the [Aegis TUI guide](/en/installation/install-dual-boot/#final-steps).
