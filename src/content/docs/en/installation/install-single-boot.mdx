...
### Aegis TUI
If you are using Aegis TUI, on **Partitioning**, select **Erase Disk** or **Replace** according to your need:
![Aegis TUI Partitioning Erase Disk](@assets/images/aegis-tui-partitioning-mode.png)

Choose if you want to install a Swap partition or not
![Aegis TUI Partitioning Erase Disk Swap](@assets/images/aegis-tui-partitioning-erasedisk-swap.png)

and select the desired swap size
![Aegis TUI Partitioning Erase Disk Swap Size](@assets/images/aegis-tui-partitioning-erasedisk-swap-size.png)
...
![Aegis TUI Partitioning Erase Disk Confirm](@assets/images/aegis-tui-partitioning-erasedisk-confirm.png)
