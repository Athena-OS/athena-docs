...
Once you land on the Live Environment, in case your Internet connection is restricted, please use a VPN service. To set a VPN, click on the network icon on the top bar and select *VPN Connections* -> *Add a VPN connection...*:
