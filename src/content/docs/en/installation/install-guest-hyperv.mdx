---
title: Installing as as guest in Hyper-V
...
![Hyper-V Manager](@assets/hyperv-manager.png)
...
![Hyper-V Create VM](@assets/hyperv-create.png)

Once finished, you should get the following window

![Hyper-V VM Created](@assets/hyperv-finish.png)
...
![Hyper-V Processors](@assets/hyperv-processor.png)

Then, move to **Integration Services** and enable **Guest services**

![Hyper-V Guest Services](@assets/hyperv-guestservices.png)
...
![Hyper-V Start VM](@assets/hyperv-start.png)
...
![Hyper-V VM Resolution](@assets/hyperv-resolution.png)

For further configuration or tricks, read the [Arch Linux Hyper-V documentation](https://wiki.archlinux.org/title/Hyper-V).

Once booted, install Athena OS as explained in [Installing as single boot](/en/installation/installing-single-boot/) chapter.

*Note: Athena OS automatically recognizes if you are using a virtualized environment so you don't need to install Hyper-V Guest Tools because the system will do automatically for you during the OS installation.*