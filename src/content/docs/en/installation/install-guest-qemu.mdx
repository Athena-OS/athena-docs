...
When the VM is run, install Athena OS as explained in [Installing as single boot](/en/installation/installing-single-boot/).
...
```
By this command, QEMU will boot the Athena OS ISO that we use for installing Athena as explained in [Installing as single boot](/en/installation/installing-single-boot/).
