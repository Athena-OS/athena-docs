...
If you are dual booting with a Windows or another Linux system, as filesystem select **don't format**, as mount point select **/boot/efi** and, if asked, as flags select **Mark as bootable partition** (**boot** flag) and **Mark as ESP partition** (**esp** flag).
