...
## Secure Boot and TPM Measurements
...
This link between Secure Boot and TPM guarantees that only systems booting in a verified and trusted state can automatically unlock encrypted volumes.
