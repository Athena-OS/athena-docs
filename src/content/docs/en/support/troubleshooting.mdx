...
it is probably caused by a wrong update of the Linux kernel or the boot partition was not correctly mounted during this process.
...
exit
```
Then, remove the ISO file and reboot the system.
