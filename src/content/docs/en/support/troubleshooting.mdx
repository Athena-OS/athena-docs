...
and you are working in a virtual machine, the issue could be caused by the VM graphic adapter. Just disable 3D Acceleration and glitches should be fixed.
