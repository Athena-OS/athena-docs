...
sudo mount --bind /tmp/intermediate /mnt/efi/

sudo arch-chroot /mnt
```
Now, check the directory tree in `/efi` folder and you should have only these files/directories:
```
...
```
This command will create the file `/efi/EFI/GRUB/grubx64.efi`.
...
UUID=0EBF-C0AD                            /efi      vfat    umask=0077 0 2
