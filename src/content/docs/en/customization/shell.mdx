...
For different colors, refer to the [ANSI escape code](https://en.wikipedia.org/wiki/ANSI_escape_code#8-bit) web resource and pass the mouse over the colors for getting the HEX code, for example:
```
