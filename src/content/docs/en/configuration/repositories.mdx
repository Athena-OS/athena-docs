...
## Athena Arch
* [Athena repository](https://github.com/Athena-OS/athena) for Athena applications, services and themes
* [BlackArch repository](https://github.com/BlackArch/blackarch) for pentesting tools
...
The structure of the Athena OS [repository package source](https://github.com/Athena-OS/athena/tree/main/src) is public and available for any contribution.
...
```
sudo curl https://raw.githubusercontent.com/Athena-OS/athena/main/src/os-specific/system/athena-mirrorlist/athena-mirrorlist -o /etc/pacman.d/athena-mirrorlist
```
