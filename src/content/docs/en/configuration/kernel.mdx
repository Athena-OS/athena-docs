...
They can be set by editing `/etc/nixos/modules/hardware/kernel/default.nix`. Use [Nix Search](https://search.nixos.org/packages) to get the correct name of the kernel package name to implement.
