...
The top bar offers several interesting itmes useful to manage your environment. On the left side there is a gear icon allowing you to access to the so called **OSettings**.
