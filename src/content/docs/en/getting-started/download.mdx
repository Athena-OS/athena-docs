...
Athena OS can be installed by an ISO file downloaded from the [official website](https://github.com/Athena-OS/athena-nix/releases) and currently available for **x86_64** architectures. Being based on Nix, the deployment of an ISO for a different architecture becomes possible.
