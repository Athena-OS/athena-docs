...
* **Containerized cyber environment**: All pentesting tools are deployed and used inside a container based on Arch Linux including [BlackArch repository](https://blackarch.org), enabling access to thousands of tools while maintaining system isolation and reducing attack surface.
