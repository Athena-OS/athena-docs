...
* When a LUKS key slot is sealed to PCR 11 (for example, `--tpm2-public-key-pcrs=11 --tpm2-pcrs=7`), it will automatically unlock only if the booted UKI matches the trusted, signed measurement policy.
