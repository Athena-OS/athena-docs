...
- Synergy with [Secure Boot](/en/security/secureboot) + [UKI](/en/security/uki) + [TPM-bound unlock](/en/security/tpm) (the boot chain is measured, and the kernel is harder to tamper with after boot).
