...
Athena Cyber Hub makes Athena OS to be your **Blue Team OS** by running the **Wazuh Management Server** where to collect **centrally** all information about **threats** and **vulnerabilities** through all endpoints where you deployed Wazuh agents.
