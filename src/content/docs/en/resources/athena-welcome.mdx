...
Currently the installation by TUI (Terminal User Interface) is available by the **Install Athena OS (TUI)** button.

The details about the installation process are described in [System Installation](/en/installation/install-baremetal/).
