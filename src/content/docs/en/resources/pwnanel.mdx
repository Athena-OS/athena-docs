...
**PWNanel** is one of the main menus in Athena OS, based on [Kando](https://github.com/kando-menu/kando), aiming to distribute centrally the main security offensive and defensive tools and the learning resources and providing great accessibility.
