...
Being an open-source distribution, Athena OS does not have a specific End User License Agreement (EULA) that governs its usage. Athena OS follows a community-driven approach and is built upon open-source principles.
